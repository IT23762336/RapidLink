...
def cleanup_ports():
    """Clean up any processes using RapidLink ports (9101, 9102, 9103)."""
    ports = [9101, 9102, 9103]
    cleaned = False
    
    print("Checking for existing processes on RapidLink ports...")
    ...
    if not cleaned:
        print("No existing processes found on RapidLink ports")
    else:
